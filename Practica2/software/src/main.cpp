...
int main(int argc, char *argv[]) {
	...
	if(argc==3){
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAGG_BLX(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAGG_BLX(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAGG_BLX(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAGG_CA(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAGG_CA(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAGG_CA(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAGE_BLX(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAGE_BLX(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAGE_BLX(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAGE_CA(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAGE_CA(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAGE_CA(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAM_BLX_10_1_0(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_1_0(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_1_0(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAM_BLX_10_0_1(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_0_1(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_0_1(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarAM_BLX_10_0_1_mej(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_0_1_mej(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarAM_BLX_10_0_1_mej(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
