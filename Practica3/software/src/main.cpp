...
int main(int argc, char *argv[]) {
	...
	if(argc==3){
		...
		cout << "/-*****************************************************************-/" << endl;
		for(int i=0; i < parts.size(); i++){
			resultados = ejecutarDE_rand(parts, i, seed);
			media.tasa_clas += resultados.tasa_clas;
			media.tasa_red += resultados.tasa_red;
			media.tiempo += resultados.tiempo;
		}
		...
		cout << "/-*****************************************************************-/" << endl;
		cout << "\t    		DE/current-to-best/1	    " << endl;
		cout << "/-*****************************************************************-/" << endl;
		for(int i=0; i < parts.size(); i++){
			resultados = ejecutarDE_best(parts, i, seed);
			media.tasa_clas += resultados.tasa_clas;
			media.tasa_red += resultados.tasa_red;
			media.tiempo += resultados.tiempo;
		}
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarES(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarES(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarES(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarILS(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarILS(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarILS(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		myfile << ",DE/Rand/1,,,,DE/Rand/1,,,,DE/Rand/1\n";

		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarDE_rand(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarDE_rand(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarDE_rand(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
		...
		myfile << ",DE/current-to-best/1,,,,DE/current-to-best/1,,,,DE/current-to-best/1\n";

		for(int i=0; i < partsC.size(); i++){
				resultados = ejecutarDE_best(partsC, i, seed);
				myfile << "Partición " << i+1 << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaC.tasa_clas += resultados.tasa_clas;
				mediaC.tasa_red += resultados.tasa_red;
				mediaC.tiempo += resultados.tiempo;
				resultados = ejecutarDE_best(partsI, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo;
				mediaI.tasa_clas += resultados.tasa_clas;
				mediaI.tasa_red += resultados.tasa_red;
				mediaI.tiempo += resultados.tiempo;
				resultados = ejecutarDE_best(partsT, i, seed);
				myfile << "," << resultados.tasa_clas << "," << resultados.tasa_red << "," <<
				agregado(resultados.tasa_clas, resultados.tasa_red) << "," << resultados.tiempo << endl;
				mediaT.tasa_clas += resultados.tasa_clas;
				mediaT.tasa_red += resultados.tasa_red;
